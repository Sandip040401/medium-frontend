...
import { Signupinput } from "@iemsandip/medium-common-file";
            ...
            <div>
                <div className="px-10">
                    ...
                    <div className="text-slate-400">
                        {type === "signin" ? "Don't have and account": "Already have and account?"} 
                ...
                <div className="pt-8">
                    {type === "signup" ? <LabelledInput label="Name" placeholder="Sandip Saha..." onChange={(e) => {
                        setPostInputs(c => ({
                            ...c,
                            name: e.target.value
                        }))
                    }}/> : null}
                    <LabelledInput label="Username" placeholder="iemsandip@gmail.com" onChange={(e) => {
                        setPostInputs(c => ({
                            ...c,
